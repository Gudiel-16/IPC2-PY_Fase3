<%@ Page Title="" Language="C#" MasterPageFile="~/interfaz/estudiante/estudiante.Master" AutoEventWireup="true" CodeBehind="estudianteVerPresentaciones.aspx.cs" Inherits="Proyecto_201404278.interfaz.estudianteVerPresentaciones" %>
     ...
     <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <label for="pwd">Ingrese Una parte o Nombre completo de curso para buscar:</label>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label for="pwd">Ingrese Carnet y Codigo de Curso Para Matricularse:</label>
            </div>
            <div class="form-group">
