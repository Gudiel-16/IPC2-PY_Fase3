<%@ Page Title="" Language="C#" MasterPageFile="~/interfaz/operador/operador.Master" AutoEventWireup="true" CodeBehind="operadorVerUsuarios.aspx.cs" Inherits="Proyecto_201404278.interfaz.operadorVerUsuarios" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h4 style="text-align: center">ADMINISTRADORES Y OPERADORES</h4>
    <br />
     ...
     <br />
      ...
      <h4 style="text-align: center">INSTRUCTORES</h4>      
