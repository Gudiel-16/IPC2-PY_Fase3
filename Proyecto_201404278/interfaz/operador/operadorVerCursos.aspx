<%@ Page Title="" Language="C#" MasterPageFile="~/interfaz/operador/operador.Master" AutoEventWireup="true" CodeBehind="operadorVerCursos.aspx.cs" Inherits="Proyecto_201404278.interfaz.operadorVerCursos" %>
     ...
     <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <label for="pwd">Ingrese Nombre de curso para buscar:</label>
            </div>
            <div class="form-group">
