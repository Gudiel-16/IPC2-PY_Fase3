...
{
    public partial class administradorEliminarReservacion : System.Web.UI.Page
    {
        ...
        protected void btteliminar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (bd.validacion_reservacion_codigo(txtCodigobuscar.Text) > 0)
                {
                    ...
                    Response.Redirect("/interfaz/administrador/administradorEliminarReservacion.aspx");
                }
                else
                {
                    MessageBox.Show("LA RESERVACION NO EXISTE");
