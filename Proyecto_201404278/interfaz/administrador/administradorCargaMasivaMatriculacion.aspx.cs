...
{
        public partial class administradorCargaMasivaMatriculacion : System.Web.UI.Page
    {
        ...
        void ExportToGrid(String path, String Extension)
        {
            ...
            if (dt1.Rows.Count > 0)
            {
                ...
                try
                {
                    string aa = mostrarDatos(GridView2);//el label toma el valor de la sintaxis de la tabla
        ...
        public string mostrarDatos(GridView tabla)
        {
            ...
            foreach (GridViewRow row in tabla.Rows)
            {
                ...
                bd.insertar_matriculacion(row.Cells[0].Text, row.Cells[1].Text);
            }
