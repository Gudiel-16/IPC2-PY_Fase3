<%@ Page Title="" Language="C#" MasterPageFile="~/interfaz/administrador/administrador.Master" AutoEventWireup="true" CodeBehind="administradorVerAsistencia.aspx.cs" Inherits="Proyecto_201404278.interfaz.administradorVerAsistencia" %>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                <label for="pwd">Buscar Por Fecha:</label>
            </div>
            <div class="form-group">
                ...
                <br />
                <asp:TextBox ID="txtBuscarPorFecha" runat="server" Style="margin-left: 0px" Width="450"></asp:TextBox>
            </div>
            <div class="form-group">
                <asp:Button ID="bttBuscarPorFecha" runat="server" Text="BUSCAR" OnClick="bttBuscarPorFecha_Click" />
           </div>
