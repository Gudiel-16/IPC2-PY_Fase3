<%@ Page Title="" StylesheetTheme="administrador" Language="C#" MasterPageFile="~/interfaz/administrador/administrador.Master" AutoEventWireup="true" CodeBehind="administradorModificarUsuario.aspx.cs" Inherits="Proyecto_201404278.interfaz.administradorModificarUsuario" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <label for="pwd">Rol que tiene el usuario que busco (No se puede modificar Rol):</label>
            </div>
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                 <asp:Button ID="bttModificar" OnClick="bttmodificar_Click" runat="server" Style="margin-left: 0px" Text="MODIFICAR"/>
            </div>
       </div>
        <div class="col-md-4">
            <div class="form-group">
